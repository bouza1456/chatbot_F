...
def startChat(user_message):
    ...
    all_messages = [{"role": "system",
                     "content": "Vous êtes un assistant de Maroc Telecom, vous pouvez uniquement répondre aux questions relatives aux offres et services de Maroc Telecom"}]
    ...
    if user_message == "topic":
        ...
        all_messages = [{"role": "system",
                         "content": f"Vous êtes un assistant pour les offres de Maroc Telecom, vous pouvez uniquement répondre aux questions relatives à Maroc Telecom"}]
