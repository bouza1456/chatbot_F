...
async function ask() {
    ...
    try {
        ...
        userMessageContainer.classList.add('message', 'message-sent'); // Add classes for right alignment
        const userMessageBubble = document.createElement('div');
        userMessageBubble.classList.add('message-bubble');
        userMessageBubble.innerHTML = '<i class="fa-solid fa-user"></i> ' + tweet;
        userMessageContainer.appendChild(userMessageBubble);
        answerDiv.appendChild(userMessageContainer);

        // Append bot response on the left side
        const botMessageContainer = document.createElement('div');
        botMessageContainer.classList.add('message', 'message-received'); // Add classes for left alignment
        const botMessageBubble = document.createElement('div');
        botMessageBubble.classList.add('message-bubble');
        botMessageBubble.innerHTML = '<i class="fa-solid fa-robot"></i> ' + data.result;
        botMessageContainer.appendChild(botMessageBubble);
        answerDiv.appendChild(botMessageContainer);
